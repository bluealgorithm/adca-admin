...
const Sidebar = () => {
  ...
  return (
    <div className="ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-hidden pb-10">
      {activeMenu && (
        <>
      ...
      <button
        ...
        className="flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md m-2 bg-red-500 mt-[80px]"
      >
        <FiLogOut />
